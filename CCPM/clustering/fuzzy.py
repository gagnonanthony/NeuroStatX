...
def fuzzyCmeans(X, max_cluster=10, m=2, error=1E-6, maxiter=1000, init=None, metric='euclidean', output='./', verbose=False):
    ...
    Returns:
        cntr:                           List of cluster centroids arrays for each model. 
        u:                              List of membership arrays for each model.
        d:                              List of distance arrays for each model.
        wss:                            List of Within-cluster Sum of Square Error value for each model. 
        fpc:                            List of fuzzy partition coefficient value for each model. 
        ss:                             List of Silhouette Coefficient Score for each model.
        chi:                            List of Calinski-Harabasz Index for each model. 
        dbi:                            List of Davies-Bouldin Index for each model.
