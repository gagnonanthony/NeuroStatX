...
def test_closenesscentrality():
    ...
    ret = runner.invoke(app, ['closenesscentrality', in_graph, 'membership', '-f'])
...
def test_betweennesscentrality():
    ...
    ret = runner.invoke(app, ['betweennesscentrality', in_graph, 'membership', '-f'])
...
def test_informationcentrality():
    ...
    ret = runner.invoke(app, ['informationcentrality', in_graph, 'membership', '-f'])
...
def test_harmoniccentrality():
    ...
    ret = runner.invoke(app, ['harmoniccentrality', in_graph, 'membership', '-f'])
...
def test_closenessvitality():
    ...
    ret = runner.invoke(app, ['closenessvitality', in_graph, 'c1', 'membership', '-f'])
